...
IGNORED_FILES_AND_DIRS=(".git" ".vscode" ".idea" "build" "__pycache__" ".DS_Store" "*.pyc" "*.pyo" "submit.tar.gz")
...
create_tar() {
  ...
  done | tar -czf "$current_dir/$output_file" -T -
